...
ActiveRecord::Schema.define(version: 2021_09_28_015709) do
  ...
  create_table "labels_notes", id: false, force: :cascade do |t|
    ...
    t.index ["label_id", "note_id"], name: "index_labels_notes_on_label_id_and_note_id"
    t.index ["note_id", "label_id"], name: "index_labels_notes_on_note_id_and_label_id"
  end
